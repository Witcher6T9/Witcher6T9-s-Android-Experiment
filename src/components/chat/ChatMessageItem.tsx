    ...
    >
      ...
      <div className="shrink-0 mt-0.5">
        <button
          ...
          title={`View ${msg.senderName}'s IE card`}
          className="focus:outline-none cursor-pointer group-hover:ring-2 group-hover:ring-[#176f78]/40 rounded-full transition-all"
        >
          {msg.senderAvatar ? (
            <img
